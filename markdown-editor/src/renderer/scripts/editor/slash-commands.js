...
(function(App) {
  ...
  function showSlashPanel() {
    console.log('[showSlashPanel] called, App.dom.slashPanel:', App.dom.slashPanel);
    const selection = window.getSelection();
    ...
    App.state.slashFilter = '';
    renderSlashList();
    console.log('[showSlashPanel] adding visible class, panel:', App.dom.slashPanel);
    App.dom.slashPanel.classList.add('visible');
    console.log('[showSlashPanel] done, panel classes:', App.dom.slashPanel.className);
  }
